...
class HttpInitialContext(object):
    ...
    def Headers(self, j):
        ...
        if o != 0:
            ...
            from homeway.Proto.HttpHeader import HttpHeader
            obj = HttpHeader()
...
def AddHost(builder, host): builder.PrependUOffsetTRelativeSlot(3, octoflatbuffers.number_types.UOffsetTFlags.py_type(host), 0)
def HttpInitialContextAddHost(builder, host):
    """This method is deprecated. Please switch to AddHost."""
    return AddHost(builder, host)
...
def AddApiTarget(builder, apiTarget): builder.PrependInt8Slot(5, apiTarget, 1)
def HttpInitialContextAddApiTarget(builder, apiTarget):
    """This method is deprecated. Please switch to AddApiTarget."""
    return AddApiTarget(builder, apiTarget)
